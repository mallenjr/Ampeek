...
export class NeweggScraper extends Scraper {
  constructor(browser: Browser, item_query_pram: string = '2060', cooldown_time: number = 10000, max_price: number = 1000.00) {
    const url = `https://www.newegg.com/p/pl?d=rtx+${item_query_pram}&N=100007709%204841&isdeptsrh=1`;
